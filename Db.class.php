 ...
 *
 * 
 * 생각해 볼 내용: 대용량 데이타의 입력(insert)
 * https://stackoverflow.com/questions/1176352/pdo-prepared-inserts-multiple-rows-in-single-query
 * https://stackoverflow.com/questions/62105003/pdo-and-binding-multiple-value-sets-during-insert
 * 
 */
...
class DB
{
    ...
    public function query($query, $params = null, $fetchmode = PDO::FETCH_ASSOC)
    {
      ...
      echo 'parameters::'.print_r($this->parameters, true) . '<br>';
